...
public class Question extends FragmentActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.publish:
			try {
				String quesdetil = ((Detilfrang) text2).getTextString()
						.getText().toString();
				String question = ((Quesfrang) text1).getTextString().getText()
						.toString();
				String questag = ((Tagfrang) text3).getTextString().getText()
						.toString();
	...
	public void postpic(RequestParams params, String id, String attach) {
		...
		client.post(url, params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
				...
				if (errno == 1) {
					Toast.makeText(Question.this, "上传成功", Toast.LENGTH_LONG)
							.show();
					try {
				...
				if (errno == -1) {
					Toast.makeText(Question.this, err, Toast.LENGTH_LONG)
							.show();
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
				...
				if (errno.equals("1")) {
					...
					try {
						...
						intent.setClass(Question.this, Detilques.class);
