	...
	public void postpic(RequestParams params, String id, String attach) {
		...
		client.post(url, params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
				...
				if (errno == 1) {
					Toast.makeText(WriteAnswer.this, "上传成功！", Toast.LENGTH_LONG)
							.show();
					try {
				...
				if (errno == -1) {
					Toast.makeText(WriteAnswer.this, err, Toast.LENGTH_LONG)
							.show();
	...
	public void postanswer(RequestParams params) {
		...
		client.post(url, params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
				...
				if (errno == 1) {
					Toast.makeText(WriteAnswer.this, "回答成功！", Toast.LENGTH_LONG)
							.show();
					attach_access_key = md5(getAttachKey());
					setResult(RESULT_OK);
